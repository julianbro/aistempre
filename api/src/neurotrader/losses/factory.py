...
class MultiTaskLoss(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.regression_loss = LossFactory.create_regression_loss(regression_type, **kwargs)
        self.short_trend_loss = LossFactory.create_classification_loss(
            classification_type, **kwargs
        )
        self.long_trend_loss = LossFactory.create_classification_loss(classification_type, **kwargs)
